...
class FinetuningConfig(object):
  ...
  def __init__(self, model_name, data_dir, **kwargs):
    ...
    self.do_test = False  # test model . use this for NER and RE(ChemProt) tasks.
    self.evaluate_bioasq=False ## Use this for BioASQ task. 
    ...
    self.qa_nbest_file=os.path.join(qa_topdir, "{:}_nbest.json").format
