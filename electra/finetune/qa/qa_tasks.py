...
class BioASQv2(SQuADTask):
  def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
    super(BioASQv2, self).__init__(config, "bioasq-squadv2", tokenizer, v2=True)

class BioASQv1(SQuADTask):
  def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
    super(BioASQv1, self).__init__(config, "bioasq-squadv1", tokenizer)
