...
class NCBI(TaggingTask):
  """NCBI"""
  def __init__(self, config, tokenizer):
    super(NCBI, self).__init__(config, "NCBI-disease", tokenizer, False)

class BC5CDRdisease(TaggingTask):
  "BC5CDR-disease"
  def __init__(self, config, tokenizer):
    super(BC5CDRdisease, self).__init__(config, "BC5CDR-disease", tokenizer, False)

class BC5CDRchem(TaggingTask):
  "BC5CDR-chem"
  def __init__(self, config, tokenizer):
    super(BC5CDRchem, self).__init__(config, "BC5CDR-chem", tokenizer, False)
